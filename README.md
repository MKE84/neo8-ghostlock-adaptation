...
| 上游仓库 | 在本项目里的角色 |
|---|---|
| [JoinChang/ghostlock-oneplus](https://github.com/JoinChang/ghostlock-oneplus)（**GhostLock 上游**，主要 payload 载体） | ghostlock 源码逻辑主体 + `run_main_route_threads` / pselect route 的全链路执行 |
| [NebuSec/CyberMeowfia](https://github.com/NebuSec/CyberMeowfia) | CVE-2026-43499 漏洞细节原始情报 + IonStack 版本实现路线 |
| [x-spy/CVE-2026-43499-popsicle](https://github.com/x-spy/CVE-2026-43499-popsicle) | 另一个 CVE-2026-43499 参考实现（drivers/cheese 路线） |
| [YuKongA/payload_extract_rs](https://github.com/YuKongA/payload_extract_rs) | OTA payload 解析管线（流式 Range 只拉 boot.img 的方案来源） |
| [martinosevilla/vmlinux-to-elf](https://github.com/marin-m/vmlinux-to-elf) | 从 Neo8 stock boot.img 解出 kallsyms 符号表 176,599 条，供 target.h 48 宏取值 |
| [gitee.com/ytngtaoaaa/allroot](https://gitee.com/ytngtaoaaa/allroot) | 社区适配流程三阶段框架（boot 采集 → AI 编译 → log 迭代） |
